...
const DepartmentCard = ({
  ...
  return (
    <button
      ...
      className="group flex flex-col items-center justify-start text-center h-full rounded-[1.25rem] bg-[#1e2e50]/80 backdrop-blur-md border border-white/10 p-8 w-full transition-all duration-300 hover:-translate-y-1 hover:bg-[#1e2e50] hover:border-white/20 hover:shadow-2xl hover:shadow-black/50 focus:outline-none focus:ring-2 focus:ring-primary/40"
    >
      {/* Icon */}
      ...
      {/* Text Content */}
      <div className="flex flex-col gap-2.5 mt-6 w-full px-2 text-white">
